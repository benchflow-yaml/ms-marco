#!/usr/bin/env python3
# BenchFlow Interface for GLUE MS Marco
# This file is a template for integrating GLUE MS Marco with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading GLUE MS Marco benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "embedding",
            "github": "https://github.com/microsoft/MSMARCO-Passage-Ranking",
            "paper": "https://arxiv.org/abs/2105.04021",
